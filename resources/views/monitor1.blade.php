...
<body onLoad="initClock()">
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div id="logospkt">
        <img src="{{asset('images/logopolwan.png')}}"  >
    </div>
  ...
  <section id="hero">
    ...
    <div class="row loket">
        <div class="col-md-5">
                ...
                <div class="col-md-6">
                        <div class="4 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1>D</h1><h1 id="sp2hp"> 0</h1><br/><button class="btn btn-success" type="button">
                    <span class="glyphicon glyphicon-credit-card">&nbsp;</span>SP2HP</button></div></div>
                <div class="col-md-6">
                        <div class="5 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1>E</h1><h1 id="sttp"> 0</h1><br/><button class="btn btn-success" type="button">
                    <span class="glyphicon glyphicon-credit-card">&nbsp;</span>STTP</button></div></div>
                <div class="col-md-6">
                        <div class="6 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1>F</h1><h1 id="sttlp"> 0</h1><br/><button class="btn btn-success" type="button">
                    <span class="glyphicon glyphicon-credit-card">&nbsp;</span>STTLP</button></div></div>
                <div class="col-md-6">
                        <div class="7 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1>G</h1><h1 id="skld"> 0</h1><br/><button class="btn btn-success" type="button">
        ...
        io.on('data', function(payload) {
            ...
            switch (payload.jenis){
                ...
                case 'lp':
                    ...
                    break;
                case 'sp2hp':
                     $('#sp2hp').html(payload.no)
                     jenis = "nomor_antrian_D"
                     break;
                case 'sttp':
                     $('#sttp').html(payload.no)
                     jenis = "nomor_antrian_E"
                     break;
                case 'sttlp':
                     $('#sttlp').html(payload.no)
                     jenis = "nomor_antrian_F"
                     break;
                case 'skld':
                     $('#skld').html(payload.no)
                     jenis = "nomor_antrian_G"
                     break;
            }
    ...
    playQueueAudio()
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                $('#sp2hp').html(data.sp2hp.no_antrian)
                $('#sttp').html(data.sttp.no_antrian)
                $('#sttlp').html(data.sttlp.no_antrian)
                $('#skld').html(data.skld.no_antrian)
