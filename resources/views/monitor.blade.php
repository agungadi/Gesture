...
<div class="row loket">
    <div class="col-md-5">
            ...
            <div class="col-md-6">
                    <div class="3 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1> 2 </h1><button class="btn btn-danger" type="button">
                <span class="glyphicon glyphicon-credit-card">&nbsp;</span>SKTLK</button></div></div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                    <div class="6 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1> 10 </h1><button class="btn btn-danger" type="button">
                <span class="glyphicon glyphicon-credit-card">&nbsp;</span>STTLP</button></div></div>
            <div class="col-md-6">
                    <div class="7 jumbotrontable" style="padding-top:20px;padding-bottom:20px;"><h1> 6 </h1><button class="btn btn-danger" type="button">
                <span class="glyphicon glyphicon-credit-card">&nbsp;</span>SKLD</button></div></div>
                    {{-- <div class="8 jumbotron" style="padding-top:20px;padding-bottom:20px;"><h1> 1020 </h1><button class="btn btn-danger" type="button"> --}}
                {{-- <span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET 8</button></div></div><div class="col-md-3">
                    <div class="9 jumbotron" style="padding-top:20px;padding-bottom:20px;"><h1> 1035 </h1><button class="btn btn-danger" type="button">
                <span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET 9</button></div></div><div class="col-md-3">
                    <div class="10 jumbotron" style="padding-top:20px;padding-bottom:20px;"><h1> 1034 </h1><button class="btn btn-danger" type="button">
                <span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET 10</button></div></div></div> --}}
    </div>
    <div class="col-md-7">
     <h1> video </h1>
    </div>
