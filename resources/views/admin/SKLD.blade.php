...
<link rel="stylesheet" href="{{asset('admin/assets/scss/style.css')}}">
  	...
  	<body>
    <div class="container">
        <button onclick="recallskld();" class="btn btn-small btn-primary"  style="float:right;padding-top:10px;padding-bottom:10px;">
            Ulangi Panggilan &nbsp;<span class="glyphicon glyphicon-volume-up"></span>
        </button>

        <div class="jumbotron" >
        <h1 id="skld" style="text-align: center;">0</h1>

        <p onclick="nextskld();" style="text-align: center;">
        ...
        <script src="{{asset('admin/assets/js/js/lib/data-table/buttons.colVis.min.js')}}"></script>
