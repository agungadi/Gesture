...
<link rel="stylesheet" href="{{asset('admin/assets/scss/style.css')}}">
  	...
  	<body>
    <div class="container">
        <button onclick="recallsttp();" class="btn btn-small btn-primary"  style="float:right;padding-top:10px;padding-bottom:10px;">
            Ulangi Panggilan &nbsp;<span class="glyphicon glyphicon-volume-up"></span>
        </button>

        <div class="jumbotron" >
        <h1 id="sttp" style="text-align: center;">0</h1>

        <p onclick="nextsttp();" style="text-align: center;">
