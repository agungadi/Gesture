...
<script src="http://localhost:3002/socket.io/socket.io.js"></script>
  	...
  	<body>
    <div class="container">
        <button onclick="recalllp();" class="btn btn-small btn-primary"  style="float:right;padding-top:10px;padding-bottom:10px;">
            Ulangi Panggilan &nbsp;<span class="glyphicon glyphicon-volume-up"></span>
        </button>

        <div class="jumbotron" >
            <h1 id="lp" style="text-align: center;">0</h1>

                <p onclick="nextlp();" style="text-align: center;">
